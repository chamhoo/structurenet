...
def add_train_3_args(parser):
    ...
    # load pretrained model (for pc exps)
    parser.add_argument('--stage_2_name', type=str, help='resume model exp name')
    parser.add_argument('--stage_2_epoch', type=int, help='resume model epoch')
